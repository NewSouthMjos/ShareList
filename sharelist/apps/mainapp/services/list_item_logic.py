...
мышью на пункт. Также добавлять пункты с помощью \
кнопки снизу.
"""
    text1 = """
Также возможен выбор "статуса" пункта, отображающегося\
в виде цвета: серый - запланировано, \
синий - в процессе, зелёный - готово.
"""

    text2 = """
Попробуйте поменять пункты местами - для этого их \
нужно перетащить мышью за номер пункта.
"""
