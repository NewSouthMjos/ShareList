...
urlpatterns = [
    ...
    path(
        "lists/<int:userlist_id>/remove",
        RemoveList.as_view(),
        name="removelist",
    ),
    path(
        "lists/<int:userlist_id>/delete",
        DeleteList.as_view(),
        name="deletelist",
    ),
    path(
        "lists/<int:userlist_id>/control",
        UserListControl.as_view(),
        name="controllist",
    ),
    path(
        "lists/<int:userlist_id>/<str:sharecode>",
        ShareListConfirm.as_view(),
        name="sharepage",
    ),
